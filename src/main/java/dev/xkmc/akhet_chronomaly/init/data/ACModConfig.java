...
public class ACModConfig {
	...
	public static final Common COMMON = AkhetChronomaly.REGISTRATE.registerUnsynced(Common::new);
	public static final Server SERVER = AkhetChronomaly.REGISTRATE.registerSynced(Server::new);
